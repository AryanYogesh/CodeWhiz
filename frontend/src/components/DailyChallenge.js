...
const DailyChallenges = () => {
  return (
    <div className="flex flex-col md:flex-row items-center justify-between text-center md:text-left p-8 bg-white dark:bg-gray-800 rounded-lg shadow-lg w-full min-h-[405px]">
